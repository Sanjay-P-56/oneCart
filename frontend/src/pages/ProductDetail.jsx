...
function ProductDetail() {
  ...
  return productData ? (
    <div>
      {/* full page */}
      <div className="w-full min-h-screen overflow-x-hidden bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start lg:flex-row flex-col gap-12 pt-20">
        {/* image */}
        <div className="lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70p] flex items-center justify-center md:gap-[10px] flex-col-reverse lg:flex-row">
        ...
        <div className="lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[60px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]">
          ...
          <div className="flex items-center gap-1">
            ...
            <FaStar className="text-[20px] fill-amber-400" />
            <FaStar className="text-[20px] fill-amber-400" />
            <FaRegStarHalfStroke className="text-[20px] fill-amber-400" />
          ...
          <p className="w-[80%] md:w-[60%] text-[20px] font-semibold pl-[5px] text-white">
            {productData.description} and stylish breathable cotton shirt with a
          ...
          <div className="flex flex-col gap-[10px] my-[10px]">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  key={index}
                  className={`border py-2 px-4 rounded-md cursor-pointer transition-colors ${
                    item === size
                      ? "bg-[#86f8b7] border-green-700"
            ...
            <button className="text-[16px] cursor-pointer bg-[#495b61c9] hover:bg-[#5c737b] active:bg-slate-600 py-2.5 px-5 rounded-2xl mt-3 border border-[#80808049] text-white font-medium transition-all duration-200 shadow" onClick={()=>addToCart(productData._id,size)}>
              Add To Cart
            </button>
          </div>
      ...
      <div className="w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden">
        ...
        <div className="w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text=[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]">
          <p className="w-[95%] h-[90%] flex items-center justify-center">
            Upgrade your wardrobe with this stylish, slim-fit cotton shirt available now on OneCart. Crafted and breathable, high-quality fabric, it offers all-day comfort and effortless style. Easy to maintain and perfect for any setting, this shirt is the must-have essential for those who value both fashion and function.
          </p>
        </div>
